...
<form action="/req/register0402" method="post">
	...
	<p>
		...
		<p><input type="radio" id="gender3" name="gender" value="other"  />
	...
	<p>
		취미 : <input type="checkbox" id="hobbys1" name="hobbys" value="drive" checked/>
			 ...
			 <input type="checkbox" id="hobbys3" name="hobbys" value="sleep" />
			 	<label for="hobbys4">취침</label><br />
	</p>
	<p>
		<!-- Y(체크) 또는 null(비체크) : String타입 -->
		개발자 여부 : <input type="checkbox" name="developer" value="Y" />
	</p>
	<p>
		<!-- false : Boolean타입  -> value속성을 작성하지 말자 => true(체크) 또는 false(비체크)-->
