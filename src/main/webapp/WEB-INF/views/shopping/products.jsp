...
scope            : page(동일 jsp) / request(동일 요청) / session(동일 웹브라우저) / application(모든 웹브라우저)
...
-->
   ...
   <div class="container">
      ...
      <div class="row" align="center">
         ...
         mav.addObject("listOfProducts", select 결과데이터);
         -->
         ...
         <div class="col-md-4"><!-- 열 별 처리 -->
            <img src="/resources/images/${product.filename}"
                 style="width:100%; height:50%; alt="${product.pname}"
                 title="${product.pname}" 
            />
            <h3>${product.pname}</h3>
