		...
		function handleImgFileSelect(e) {
			...
			fileArr.forEach(function(f) {
				...
				reader.onload = function(e) {
					...
					$(".bg-register-image2").removeClass("bg-register-image");
				}
	...
	<div class="col-lg-7">
		<div class="p-5">
			...
			<!-- 
               ...
               요청방식 : post
          -->
			<form class="bookInfoFrm" action="/bookInfo/addBookPost?${_csrf.parameterName}=${_csrf.token}"
				method="post" enctype="multipart/form-data">
				<!-- 폼데이터 -->
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<input type="text" class="form-control form-control-user"
							id="bookId" name="bookId" placeholder="도서코드" readonly required />
				...
				<div class="form-group">
					<textarea class="form-control form-control-user" id="description"
						name="description" placeholder="상세정보"></textarea>
				</div>
				<div class="form-group row">
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="condition"
							id="condition1" value="신규도서" checked> <label
							class="form-check-label" for="condition1">신규도서</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="condition"
				...
				<button type="submit" class="btn btn-primary btn-user btn-block">도서
					등록</button>
