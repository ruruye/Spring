...
스프링 폼을 이용하면 HTML 폼(뷰, jsp)과 자바객체(Controller의 ..)를 쉽게 바인딩(연결)할 수 있음
</pre>
...
<%-- 		<form:hidden path="userId" /> --%>
	...
	<p>
		...
		카드1-유효년월 : <form:input path="cardVOList[0].validMonth" placeholder="202401"/>
		...
		카드2-유효년월 : <form:input path="cardVOList[1].validMonth" placeholder="202401"/>
